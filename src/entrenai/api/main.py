...
async def startup_event():
    logger.info(f"Entrenai API starting up...")
...
if __name__ == "__main__":
    ...
    import uvicorn
    logger.info("Running FastAPI app directly using Uvicorn (for development/debugging).")
    uvicorn.run(app, host=base_config.fastapi_host, port=base_config.fastapi_port, log_level=base_config.log_level.lower())
